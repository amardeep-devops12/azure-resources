...
--------|----------------------------|
Linux |`ubuntu2204`, `ubuntu1804`, `ubuntu1604`, `centos75`, `coreos`
...
## Example for creating windows virtual machine scaleset
...
module "vmss" {
  source = "./modules/vmss"
  resource_group_name = "python123"
  vnet_name              = "test" #module.network.vnet_name
  subnet_name           = "public-subnet-0"
